...
export default {
  ...
  data() {
    return {
      ...
      mensajes: [
        { numero: 1, intencion: "Consulta sobre facturación", tiempo: "hace 5 minutos" },
        { numero: 2, intencion: "Reclamo por servicio", tiempo: "hace 15 minutos" },
        { numero: 3, intencion: "Solicitud de información", tiempo: "hace 30 minutos" }
      ]
    };
  }
};
    ...
    <div class="messages-wrapper">
      <div class="messages-container">
        <div class="messages-header">
          ...
          <h3>Mensajes de Tickets</h3>
        </div>
        <ul class="messages-list">
          <li v-for="(msg, index) in messages" :key="index">
<!--            #{{ msg.number }} - {{ msg.intention }} - {{ msg.timeAgo }}        Falta backend para terminar esta llamada-->
          </li>
        </ul>
      </div>
    </div>
