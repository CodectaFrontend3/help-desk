<template>
    <div class="another-page">
      ...
      >
        ...
        <!-- Botones -->
        <ButtonGroup :buttons="buttonData" :currentView="currentView" @updateView="updateCurrentView" />
        ...
        <div v-if="currentView === 'empresa'" class="form-section">
          ...
          <FormGroup label="RUC">
            <input type="text" class="form-input" placeholder="12345678901" />
          </FormGroup>
          <FormGroup label="Razón Social">
            <input type="text" class="form-input" placeholder="Empresa SAC" />
          </FormGroup>
          ...
          <FormGroup label="Distrito">
            <Dropdown :options="['Miraflores', 'San Isidro', 'Surco']" />
          </FormGroup>
          <FormGroup label="Dirección Fiscal">
            <input type="text" class="form-input" placeholder="Av. Principal 123" />
          </FormGroup>
        </div>
        ...
        <div v-if="currentView === 'facturacion'" class="form-section">
          ...
          <FormGroup label="Observaciones">
            <textarea class="form-input" placeholder="Notas adicionales..."></textarea>
          </FormGroup>
        </div>
        ...
        <div v-if="currentView === 'acceso'" class="form-section">
          ...
          <FormGroup label="Nombre de Usuario">
            <input type="text" class="form-input" placeholder="usuario123" />
          </FormGroup>
