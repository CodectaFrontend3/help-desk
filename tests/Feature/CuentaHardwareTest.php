...
it('listar de los registros de hardware', function () {
    ...
    $response = $this->getJson('/api/registroHardware');
...
it('crear un nuevo registro de hardware', function () {
    ...
    $response = $this->postJson('/api/registroHardware', $data);
...
it('mostrar un registro de hardware específico', function () {
    ...
    $response = $this->getJson("/api/registroHardware/{$registro->id}");
...
it('actualizar un registro de hardware', function () {
    ...
    $response = $this->putJson("/api/registroHardware/{$registro->id}", [
        ...$registro->toArray(),
...
it('eliminar un registro de hardware', function () {
    ...
    $response = $this->deleteJson("/api/registroHardware/{$registro->id}");
